#ifndef UCSCONNECTIONPOOL_H
#define UCSCONNECTIONPOOL_H
...
private:
    static UCSConnectionPool& getInstance();

    UCSConnectionPool();
    UCSConnectionPool(const UCSConnectionPool &other);
    UCSConnectionPool &operator =(const UCSConnectionPool &other);
    ~UCSConnectionPool();
...
private:
    ...
    static UCSConnectionPool *m_instance;
