...
UCSDBHelper::UCSDBHelper()
{

}

bool UCSDBHelper::transactionSupported()
{
    UCSDBScoped scoped;
...
bool UCSDBHelper::checkTableExist(QString tableName)
{
    UCSDBScoped scoped;
    QSqlDatabase db = scoped.db();
...
bool UCSDBHelper::checkAndCreateTable(QString sql, QString tableName)
{
...
QString UCSDBHelper::formatValueCondition(MapValues values, MapConditions conditions)
{
    QString strSql;
    QString strValue;
